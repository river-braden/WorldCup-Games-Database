...
ALTER SEQUENCE public.my_serial OWNED BY public.teams.team_id;


--
-- Name: my_serial1; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.my_serial1
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.my_serial1 OWNER TO freecodecamp;

--
-- Name: my_serial1; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.my_serial1 OWNED BY public.games.game_id;
...
ALTER TABLE ONLY public.games ALTER COLUMN game_id SET DEFAULT nextval('public.my_serial1'::regclass);
...
ALTER TABLE ONLY public.teams ALTER COLUMN team_id SET DEFAULT nextval('public.my_serial'::regclass);
...
SELECT pg_catalog.setval('public.my_serial', 224, true);


--
-- Name: my_serial1; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.my_serial1', 32, true);
...
--
-- Name: games opponent_constraint; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT opponent_constraint FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games winner_constraint; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT winner_constraint FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
